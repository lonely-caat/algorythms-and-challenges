...
//
// Hint: the hard part of this is figuring out the name of the proeprty on the criteria.  You can use Object.keys(criteria)[0]
// to figure out the name of the property on the object.
// For example, Object.keys({ height: '20 feet' }) would return 'height'.
// You could then check to see if a given element in the array had a property equal
// to the criteria's value with something like element[property] === criteria[property].
//
//
//


// console.log(ladders.find(l=>l.height===25))
